...
def test_format_seconds():
    ...
    assert utils.format_seconds(3661) == "01:01:01", "Should format 3661 seconds correctly"
    assert utils.format_seconds(60) == "00:01:00", "Should format 60 seconds correctly"
    assert utils.format_seconds(86399) == "23:59:59", "Should handle edge cases correctly"
...
def test_replace_empty():
    ...
    assert utils.replace_empty("text") == "text", "Should return the original string if not empty"
